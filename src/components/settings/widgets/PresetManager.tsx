...
export const PresetManager: React.FC<PresetManagerProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4 backdrop-blur-md animate-in fade-in duration-200">
            <div className="bg-white dark:bg-[#1e1e1e] w-full max-w-md rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-gray-200 dark:border-gray-800">
                {/* Header */}
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3 min-h-[300px] max-h-[60vh]">
                    ...
                    {presets.length === 0 ? (
                        ...
                        presets.map(preset => (
                            <div key={preset.id} className="group bg-gray-50 dark:bg-black/20 p-3 rounded-xl border border-gray-200 dark:border-white/5 hover:border-[var(--btn-bg)] hover:dark:border-[var(--btn-bg)] transition-colors flex justify-between items-center shadow-sm">
                                <div>
                                ...
                                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    ...
                                    <button
                                        ...
                                        className="p-2 rounded-lg bg-[var(--bg-card-secondary)] text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--border-color)]"
