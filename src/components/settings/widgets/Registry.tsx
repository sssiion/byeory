...
export const WIDGET_REGISTRY: Record<string, { component: React.ComponentType<any>, label: string, defaultProps?: any, defaultSize?: string, category: string }> = {
    ...
    'polaroid': { component: Decoration.Polaroid, label: '폴라로이드', defaultProps: { date: '2023.12.25', src: 'https://images.unsplash.com/photo-1511895426328-dc8714191300?w=400' }, defaultSize: '1x1', category: 'Decoration' },
    ...
    'ootd': { component: Decoration.OOTDSketch, label: 'OOTD', defaultSize: '1x1', category: 'Decoration' },
    ...
    'lp-player': { component: Interactive.LPPlayer, label: '턴테이블', defaultSize: '2x1', category: 'Interactive' },
};
