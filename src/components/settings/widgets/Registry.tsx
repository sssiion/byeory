...
export const WIDGET_REGISTRY: Record<string, { component: React.ComponentType<any>, label: string, defaultProps?: any, defaultSize?: 'small' | 'medium' | 'large' | 'wide', category: string }> = {
    ...
    'unit-converter': { component: Tools.UnitConverter, label: '단위 변환기', defaultSize: 'large', category: 'Utility' },
    'calculator': { component: Tools.Calculator, label: '계산기', defaultSize: 'large', category: 'Utility' },
