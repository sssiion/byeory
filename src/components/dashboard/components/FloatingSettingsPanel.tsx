    ...
    return (
        <>
            ...
            <button
                ...
                className={`fixed right-0 top-32 z-40 mt-6 flex items-center justify-center w-12 h-14 
            ...
            <div
                className={`fixed right-0 top-32 z-50 w-64 flex flex-col gap-4 bg-[var(--bg-card)]/80 backdrop-blur-xl border-y border-l border-[var(--border-color)] rounded-l-3xl p-5 min-h-[240px] shadow-2xl transition-transform duration-500 ease-[cubic-bezier(0.34,1.56,0.64,1)]
